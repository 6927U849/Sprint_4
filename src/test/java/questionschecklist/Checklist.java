...
public class Checklist {
    ...
    public Checklist(String question, String answer) {
    ...
    public void ListTest() {
        MainPage mainPage = new MainPage(driver);//Пеходим к 'Вопросы о важном'
        mainPage.goToFAQ();//скролим
        mainPage.openAccordionQuestion(question);//Нажимаем на вопрос: " + question
